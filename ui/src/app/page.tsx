    ...
    <main className="bg-background text-foreground min-h-svh">
      <div className="mx-auto flex min-h-svh max-w-7xl flex-col gap-6 px-4 py-5 sm:px-8 sm:py-8">
        <header className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <a
            href="https://github.com/navincodesalot/terahertz"
            target="_blank"
          ...
          >
            ...
            <span className="text-xs hidden sm:inline">source layouts + code</span>
          </a>
        </header>
      ...
      <footer className="border-t px-4 py-4 sm:px-8 flex justify-center">
        <a
          href="https://github.com/navincodesalot/terahertz"
          target="_blank"
          rel="noopener noreferrer"
          className="text-muted-foreground hover:text-foreground group flex w-fit items-center gap-1.5 text-xs transition-colors"
        >
          made with
          ❤️
          by navin
